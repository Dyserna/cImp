...
Branch `feat/v39-cross-harness-delegation` at `e61e911` (25 commits, phases A/B/C).
...
| M-10 | MED | Remote knobs use whole-document save; can revert an in-flight role change (`d063831` class) | FIX — narrow IPC `tab_set_delegation_backend` |
...
## Verification pass (same reviewer, over `e61e911..ca2d7a1`)
