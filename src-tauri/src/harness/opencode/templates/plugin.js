...
const CIMP_LOOPBACK = {{cimp.loopback_url}};
...
const CIMP_CHP = {{cimp.chp_version}};
const CIMP_INJECT_ENABLED = {{cimp.flag.inject}};
const CIMP_AUTO_CHECK_ENABLED = {{cimp.flag.auto_check}};
...
// observe.
const CIMP_BEACON_ENABLED = {{cimp.flag.beacon}};
...
const CIMP_CHECKPOINT_ENABLED = {{cimp.flag.checkpoint}};
const CIMP_MUTATING_TOOLS = new Set({{cimp.tools.mutating}});
...
const CIMP_NATIVE_GATE_ENABLED = {{cimp.flag.native_gate}};
const CIMP_NATIVE_LOCAL_TOOLS = new Set({{cimp.tools.local}});
const CIMP_REFUSAL_NATIVE_LOCAL = {{cimp.refusal.local}};
const CIMP_REFUSAL_NATIVE_WEB = {{cimp.refusal.web}};
...
const CIMP_REFUSAL_NATIVE_WEB_TAINTED = {{cimp.refusal.web_tainted}};
...
const CIMP_REFUSAL_NATIVE_WEB_USER_LOCAL = {{cimp.refusal.web_user_local}};
  ...
  if (CIMP_TAB_MATCH) {
    const hello = CIMP_FETCH(CIMP_LOOPBACK + "/session/hello", {
      ...
      body: JSON.stringify({
        ...
        serves: {{cimp.hello.serves}},
        cannot: {{cimp.hello.cannot}},
      }),
