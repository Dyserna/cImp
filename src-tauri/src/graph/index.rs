...
use super::memory::{
    ProjectFact, SessionInfo, WorkingSetEntry, MAX_EVENTS_PER_SESSION,
    MAX_LIVE_PROJECT_FACTS, MAX_SESSIONS_PER_ROOT, SESSION_RETENTION_DAYS,
};
...
mod tests {
    use super::*;
    use crate::graph::memory::UsageEvent;
