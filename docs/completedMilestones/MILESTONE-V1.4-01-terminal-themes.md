...
- No per-tab avatar override. Originally slated as V1.4-05 but cancelled (avatar stays global-only — see `docs/FUTURE-FEATURES.md` historical section). Schema does *not* add `avatar_override`.
- No per-tab TTS override. Originally slated as V1.4-06 but cancelled (TTS stays global-only — see `docs/FUTURE-FEATURES.md` historical section). Schema does *not* add `tts_override`.
